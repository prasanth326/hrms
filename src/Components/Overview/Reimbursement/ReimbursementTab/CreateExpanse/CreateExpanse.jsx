...
import styles from "./CreateExpanse.module.css"
import { Button } from '@mui/material';

export default function CreateExpanse({setOpenNewExpense}) {
    ...
    return (
        <div>
            <div className={styles.backbtn} onClick={()=>{setOpenNewExpense(false)}}><img src={backbtn}/></div>
