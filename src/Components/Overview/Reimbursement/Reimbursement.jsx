  ...
  return (
    <div className={styles.reimbursementConatiner}>
      <div className={styles.reimbursementTabs}>
        <div
          className={`${styles.expences} ${
            activeTab === "EXPENCES" ? styles.active : ""
          }`}
          onClick={() => setActiveTab("EXPENCES")}
        >
          EXPENCES
        </div>
        <div
          className={`${styles.expences} ${
            activeTab === "REIMBURSMENTS" ? styles.active : ""
          }`}
          onClick={() => setActiveTab("REIMBURSMENTS")}
        >
          REIMBURSMENTS
        </div>
        <div
          className={`${styles.expences} ${
            activeTab === "ADVANCES" ? styles.active : ""
          }`}
              ...
              <div className={styles.createNew}>
                ...
                <div className={styles.expenceImageUploadBrowswer}>
                  ...
                  <div className={styles.expenceUpload}>
                    ...
                    <div className={styles.expenceUploadfile}>
                      Files Types: Pdf, Jpeg, Png, Jpg, Xlsx, Csv, Eml,Max size,
                      10 mb
                    </div>
                  </div>
      ...
      {activeTab === "REIMBURSMENTS" ? (
        <ReimbursementTab
          setopenTagexpense={setopenTagexpense}
          openTagexpense={openTagexpense}
          setOpenNewExpense={setOpenNewExpense}
